...
<title
	>SaMoTech Robotics{path === '' ? '' : ' » ' + path.charAt(0).toUpperCase() + path.slice(1)}</title
>
	...
	{#if !miniNav}
		<div class="navbar">
			...
			<div class="tabs {path}">
				...
				<a href="/about" class:active={path === 'about'}> About Us </a>
				<a href="/news" class:active={path === 'news'}> News </a>
				<a href="/middleSchool" class:active={path === 'middleSchool'}> Middle School </a>
		...
		<div class="navbar mini">
			...
			<div class="mobile-menu" class:open={menuOpen}>
				<div class="mobile-tabs">
					...
					<a href="/middleSchool" class:active={path === 'middleSchool'}> Middle School </a>
					<a href="/sponsors" class:active={path === 'sponsors'}> Sponsors </a>
					<a href="/support" class:active={path === 'support'}> Support </a>
				</div>
			</div>
		</div>
	{/if}
		...
		.navbar {
			...
			.mobile-menu {
				...
				background: linear-gradient(
					transparentize($primary-dark, 0.6) 0%,
					transparentize($primary-dark, 0.1) 25%,
					transparentize($primary-dark, 0.05) 100%
				);
				backdrop-filter: blur(2px);
